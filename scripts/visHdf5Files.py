...
parser.add_argument('--rgb_keys', nargs='+', help='Keys that should be interpreted as rgb data.', default=["colors", "normals", "eevee", "diffuse", "noisy", "lighting_glossdir", "lighting_glossindir", "lighting_diffdir", "lighting_diffindir","lighting_diffcol", "lighting_glosscol"])
...
parser.add_argument('--other_non_rgb_keys', nargs='+', help='Keys that contain additional non-RGB data which should be visualized using a jet color map.', default=["distance", "depth", "roughness"])
